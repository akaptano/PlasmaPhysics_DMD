...
l7 = plt.plot(x,0.044*np.ones(len(x)),color='b',linewidth=6,linestyle='--',label=r'DMD error, r = 140')
plt.yscale('log')
plt.xscale('log')
...
ax = plt.gca()
ax.annotate('sparsity-promoting DMD\nconverges to traditional DMD', xy=(1.4, 6e-2),fontsize=26, xytext=(1.6, 0.3), \
